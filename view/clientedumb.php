    ...
    <tbody>
        ...
        ?>
            ...
            <tr>
                ...
                <td><?php  echo $row['name_cd']?></td>
                <td><?php  echo $row['apel_cd']?></td>
                <td><?php  echo $row['cedu_cd']?></td>
                <td><a class="edit" href="restore_clie.php?id=<?php echo $row['ID_cd'] ?>" >Restaurar</a></td>
            </tr>
...
<center><a class="delete" href="controlador/drop_clied.php">Vaciar papelera</a></center>