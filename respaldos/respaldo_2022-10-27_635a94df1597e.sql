...
("49","INSERTAR","root","localhost","2022-10-26 18:38:33","USUARIO"),
("50","BORRAR","root","localhost","2022-10-26 18:39:12","USUARIO"),
("51","INSERTAR","root","localhost","2022-10-26 18:39:24","USUARIO"),
("52","BORRAR","root","localhost","2022-10-26 18:39:52","USUARIO"),
("53","INSERTAR","root","localhost","2022-10-26 18:45:39","PUESTO DE TRABAJO"),
("54","INSERTAR","root","localhost","2022-10-27 00:04:26","CLIENTE"),
("55","BORRAR","root","localhost","2022-10-27 00:04:58","CLIENTE"),
("56","BORRAR","root","localhost","2022-10-27 00:05:50","INVENTARIO"),
("57","INSERTAR","root","localhost","2022-10-27 05:22:13","INVENTARIO"),
("58","INSERTAR","root","localhost","2022-10-27 05:22:51","INVENTARIO"),
("59","BORRAR","root","localhost","2022-10-27 05:23:49","INVENTARIO"),
("60","BORRAR","root","localhost","2022-10-27 05:23:50","INVENTARIO"),
("61","BORRAR","root","localhost","2022-10-27 05:23:51","INVENTARIO"),
("62","INSERTAR","root","localhost","2022-10-27 05:24:23","INVENTARIO"),
("63","INSERTAR","root","localhost","2022-10-27 05:25:09","INVENTARIO"),
("64","INSERTAR","root","localhost","2022-10-27 05:25:36","INVENTARIO"),
("65","INSERTAR","root","localhost","2022-10-27 05:26:26","INVENTARIO"),
("66","INSERTAR","root","localhost","2022-10-27 05:27:57","INVENTARIO"),
("67","INSERTAR","root","localhost","2022-10-27 05:30:35","INVENTARIO"),
("68","INSERTAR","root","localhost","2022-10-27 05:34:24","MONEDA"),
("69","INSERTAR","root","localhost","2022-10-27 05:34:24","MONEDA"),
("70","ACTUALIZAR","root","localhost","2022-10-27 05:35:11","MONEDA"),
("71","INSERTAR","root","localhost","2022-10-27 08:42:37","USUARIO"),
("72","BORRAR","root","localhost","2022-10-27 08:43:13","USUARIO"),
("73","INSERTAR","root","localhost","2022-10-27 09:50:47","NOMINA"),
("74","INSERTAR","root","localhost","2022-10-27 09:51:12","PUESTO DE TRABAJO"),
("75","BORRAR","root","localhost","2022-10-27 09:55:00","USUARIO"),
("76","INSERTAR","root","localhost","2022-10-27 09:55:18","USUARIO");
...
INSERT INTO clientedumb VALUES
("7","christopher","silva","0");
...
CREATE TABLE `compra` (
  ...
  CONSTRAINT `inventario` FOREIGN KEY (`ID_inve`) REFERENCES `inventario` (`ID_inve`),
  CONSTRAINT `proveedor` FOREIGN KEY (`ID_prove`) REFERENCES `proveedor` (`ID_prove`)
...
CREATE TABLE `facturas` (
  ...
  PRIMARY KEY (`ID_fact`),
  KEY `cliente` (`ID_clie`),
  CONSTRAINT `cliente` FOREIGN KEY (`ID_clie`) REFERENCES `cliente` (`ID_clie`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
("14","2022-10-26","2022-11-05","sal 1kg","marina","100","50.00"),
("15","2022-12-10","2022-10-26","fesco 1L","cocacola","50","60.00"),
("16","2022-10-26","2022-11-05","fresco 2L","cocacola","50","100.00"),
("17","2022-10-26","2022-11-05","fesco 1L","pexi","200","50.00"),
("18","2022-10-27","2022-11-05","lapiz","mongol","200","10.00"),
("19","2022-10-27","2022-11-05","cigarrillo","carnival","200","5.00");
...
("3","2022-12-10","2022-10-20","harina","robinson","20","88"),
("11","2022-10-26","2022-10-26","Papel carta","Alpex","30","0"),
("12","2022-11-05","2022-10-26","sal ","marina","100","50"),
("13","2022-11-05","2022-11-26","fesco","cocacola","150","40");
...
("21","david","hernandaz","ferreo","aaa","98789876","41423454","2022-10-27","3");
...
CREATE TABLE `nominadumb` (
  ...
  PRIMARY KEY (`ID_nd`),
  CONSTRAINT `nominadumb_ibfk_1` FOREIGN KEY (`ID_nd`) REFERENCES `nomina` (`ID_nom`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `venta` (
  ...
  PRIMARY KEY (`ID_ven`),
  KEY `ID_inve` (`ID_inve`),
  CONSTRAINT `inventariou` FOREIGN KEY (`ID_inve`) REFERENCES `inventario` (`ID_inve`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
