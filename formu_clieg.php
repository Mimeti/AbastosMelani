        ...
        <nav class="content_nav">
            ...
            <ul class="nav_menu">
                <li class="nav_menu_item">
                    <a href="clientesg.php" class="nav_menu_link nav_link">Volver</a>
                </li>
            ...
            <ul id="nav_ul" class="nav_respon activado">
                <li class="nav_respon_item1">
                    <a href="clientesg.php" class="nav_respon_link nav_link"><span class="icon icon-cog"> Volver</span></a>
                </li>
            </ul>
        </nav>
    </header>

    <form action="controlador/ingresar_clienteg.php" method="POST" id="form">
        <div class="form">
