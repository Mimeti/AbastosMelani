        ...
        <nav class="content_nav">
            ...
            <ul class="nav_menu">
                <li class="nav_menu_item">
                    <a href="" class="nav_menu_link nav_link">inicio</a>
                </li>
                <li class="nav_menu_item">
                    <a href="index_produ.php" class="nav_menu_link nav_link">inventario</a>
                </li>
                <li class="nav_menu_item">
                    <a href="" class="nav_menu_link nav_link">bitacora</a>
                </li>
            </ul>
